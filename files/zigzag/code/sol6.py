...
class CardCollection():
    ...
    def DisplayStats(self):
      ...
      print(f"There is a {keyChance:0.2f}% chance that the next card will be a key, a {fileChance:0.2f}% chance that it will be a file and a {pickChance:0.2f}% chance that it will be a pick.")
    # END ADDITION
