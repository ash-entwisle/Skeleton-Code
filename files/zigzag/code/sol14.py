    ...
    def IsPartial(self, seq):
      ...
      for C in self._Challenges:
        ...
        if len(condition) == 3:
          ...
          if seqLen > 0 and condition[1] == seq.GetCardDescriptionAt(seqLen) and condition[0] == seq.GetCardDescriptionAt(seqLen-1):
            partial = True
          elif seqLen >= 0 and condition[0] == seq.GetCardDescriptionAt(seqLen):
            partial = True
      return partial
    # END ADDITION
