        ...
        for C in self._Challenges:
            if C.GetMet():
                ...
                if len(condition) == 3:
                  ...
                  if seqLen > 0 and condition[1] == sequence.GetCardDescriptionAt(seqLen) and condition[0] == sequence.GetCardDescriptionAt(seqLen-1):
                    LockDetails += "Partially met: "
                  elif seqLen >= 0 and condition[0] == sequence.GetCardDescriptionAt(seqLen):
                    LockDetails += "Partially met: "
                  else:
                    LockDetails += "Not met:       "
                else:
